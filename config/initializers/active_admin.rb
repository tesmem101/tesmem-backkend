ActiveAdmin.setup do |config|
  ...
  # == Setting a Favicon
  #
  config.favicon = "/images/logo.png"
  ...
  #
    config.namespace :admin do |admin|
      admin.build_menu :utility_navigation do |menu|
        ...
        menu.add  :label => proc { current_user.email }, :url => proc {  admin_user_path(current_user) } ,:id => 'current_user' # This is custome menu item 
  ...
  #
    config.namespace :admin do |admin|
      admin.build_menu :default do |menu|
        # menu.add label: "My Great Website", url: "http://www.mygreatwebsite.com", html_options: { target: :blank }
        menu.add label: "Dashboards", url: "#{ENV["HOST_URL"]}/admin/designer_dashboards", html_options: { target: :blank }, priority: 0
      end
    end
